  ...
  TimeGrid.prototype.renderHeader = function renderHeader(range, events, width) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_DateContentRow2.default, (_React$createElement = {
          now: now,
          minRows: 2,
          range: range,
          rtl: this.props.rtl,
        ...
        }, _React$createElement['now'] = now, _React$createElement))
      )
    );
  };
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function (date, i) {
      ...
      return _react2.default.createElement(
        ...
        {
          key: i,
          className: (0, _classnames2.default)('rbc-header', _dates2.default.eq(date, now, 'day') && 'rbc-today'),
