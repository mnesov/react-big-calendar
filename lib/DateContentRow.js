...
var propTypes = {
  ...
  now: _react2.default.PropTypes.instanceOf(Date).isRequired
};
...
var DateContentRow = function (_React$Component) {
  ...
  function DateContentRow() {
    ...
    _this.renderHeadingCell = function (date, index) {
      ...
      return renderHeader({
        ...
        className: (0, _classnames2.default)('rbc-date-cell', _dates2.default.eq(date, now, 'day') && 'rbc-now')
      });
    };
  ...
  DateContentRow.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['rtl', 'events', 'range', 'now', 'className', 'selectable', 'renderForMeasure', 'startAccessor', 'endAccessor', 'renderHeader', 'minRows', 'maxRows', 'dateCellWrapper', 'eventComponent', 'eventWrapperComponent', 'onSelectStart', 'onSelectEnd']);
